...
function M.setup()
  ...
  -- local dap = require 'dap'     -- moved to lazy require
  -- local dapui = require 'dapui' -- moved to lazy require
  -- local tmux = require 'config.tmux' -- moved to lazy require
  -- local jumper = require("telescope").extensions.jumper -- moved to lazy require
