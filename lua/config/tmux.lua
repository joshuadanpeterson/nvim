...
-- Keybindings
vim.api.nvim_set_keymap('n', '<Leader>ts', '<cmd>lua require("config.tmux").switch_to_tmux_session()<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<Leader>tw', '<cmd>lua require("config.tmux").switch_tmux_window()<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<Leader>tp', '<cmd>lua require("config.tmux").switch_tmux_pane()<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<Leader>tm', '<cmd>lua require("config.tmux").tmux_menu_picker()<CR>', { noremap = true, silent = true })
