        ...
        config = function()                        -- Configuration function for the plugin
                require('obsidian').setup({
                        ...
                        completion = {
                                ...
                                new_notes_location = "current_dir", -- Default location for creating new notes
                                prepend_note_id = true,             -- Add note ID for unique identification in links
                                prepend_note_path = false,          -- Option to prepend path in links (disabled here)
                                use_path_only = false,              -- Use only the path for link completion (disabled here)
                        ...
                        -- Configuration for handling backlinks
                        backlinks = {
                                height = 10, -- Height of the backlinks window
                                wrap = true, -- Enable text wrapping in the backlinks window
                        },

                        -- Configuration for handling tags
                        tags = {
                                height = 10, -- Height of the tags window
                                wrap = true, -- Enable text wrapping in the tags window
                        },
